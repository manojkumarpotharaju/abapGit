class ZCL_ZGW_WORKFLOW_APPRO_MPC definition
  public
...
TT_GROUPS type standard table of TS_GROUPS .
  types:
     TS_APPROVALFLOW_HEADER type Y229_ST_HEADER .
  types:
TT_APPROVALFLOW_HEADER type standard table of TS_APPROVALFLOW_HEADER .

  constants GC_APPROVALFLOW_HEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ApprovalFlow_Header' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_WORKFLOW_APPRO_MPC====CP' ##NO_TEXT.
  ...
  methods DEFINE_GROUPS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_APPROVALFLOW_HEADER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZGW_WORKFLOW_APPRO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_WORKFLOW_APPROVAL_VIEW_SRV' ).
...
define_elements( ).
define_groups( ).
define_approvalflow_header( ).
define_associations( ).
  endmethod.


  method DEFINE_APPROVALFLOW_HEADER.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - ApprovalFlow_Header
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ApprovalFlow_Header' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ApprovalFlow_HeaderSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_WORKFLOW_APPRO_MPC=>TS_APPROVALFLOW_QUICKVIEW' ). "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'HeaderEntityToNodes' "#EC NOTEXT
                            iv_left_type        = 'ApprovalFlow_Header' "#EC NOTEXT
                            iv_right_type       = 'ApprovalFlow_Nodes' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - HeaderEntityToNodes
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'HeaderEntityToNodesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ApprovalFlow_HeaderSet'              "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ApprovalFlow_LanesSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'APPROVALFLOW_LANESSET' "#EC NOTEXT
                                                              iv_association_name = 'HeaderEntityToNodes' ). "#EC NOTEXT
* Navigation Properties for entity - ApprovalFlow_Header
lo_entity_type = model->get_entity_type( iv_entity_name = 'ApprovalFlow_Header' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ApprovalFlow_NodesSet' "#EC NOTEXT
                                                              iv_abap_fieldname = 'APPROVALFLOW_NODESSET' "#EC NOTEXT
                                                              iv_association_name = 'HeaderEntityToNodes' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230512180107'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'DocumentType'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ApprovalFlow_Header'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
