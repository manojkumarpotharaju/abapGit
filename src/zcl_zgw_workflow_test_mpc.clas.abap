class ZCL_ZGW_WORKFLOW_TEST_MPC definition
  public
...
public section.
  ...
  types:
     TS_APPRLANES type Y229_ST_LANES .
  types:
TT_APPRLANES type standard table of TS_APPRLANES .
  types:
  ...
  types:
     TS_APPRNODES type Y229_ST_NODES .
  types:
TT_APPRNODES type standard table of TS_APPRNODES .
  types:
     TS_APPRCOMMENTS type Y229_ST_COMMENTS .
  types:
TT_APPRCOMMENTS type standard table of TS_APPRCOMMENTS .
  types:
     TS_APPRHEADER type Y229_ST_HEADER .
  types:
TT_APPRHEADER type standard table of TS_APPRHEADER .

  constants GC_APPRCOMMENTS type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ApprComments' ##NO_TEXT.
  constants GC_APPRHEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ApprHeader' ##NO_TEXT.
  constants GC_APPRLANES type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ApprLanes' ##NO_TEXT.
  constants GC_APPRNODES type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ApprNodes' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_WORKFLOW_TEST_MPC=====CP' ##NO_TEXT.

  methods DEFINE_APPRLANES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_APPRNODES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_APPRCOMMENTS
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZGW_WORKFLOW_TEST_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_WORKFLOW_TEST_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ApprComments' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ApprCommentsSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ApprLanes' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ApprLanesSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ApprNodes' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ApprNodesSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'ApprHeaderToApprLanes' "#EC NOTEXT
                            iv_left_type        = 'ApprHeader' "#EC NOTEXT
                            iv_right_type       = 'ApprLanes' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - ApprHeaderToApprLanes
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ApprHeaderToApprLanesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ApprHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ApprLanesSet'             "#EC NOTEXT
                                              iv_association_name      = 'ApprHeaderToApprLanes' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'ApprHeaderToApprNodes' "#EC NOTEXT
                            iv_left_type        = 'ApprHeader' "#EC NOTEXT
                            iv_right_type       = 'ApprNodes' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - ApprHeaderToApprNodes
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'DocumentType'   iv_dependent_property = 'DocumentType' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'DocumentId'   iv_dependent_property = 'DocumentId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ApprHeaderToApprNodesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ApprHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ApprNodesSet'             "#EC NOTEXT
                                              iv_association_name      = 'ApprHeaderToApprNodes' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'ApprHeaderToApprComments' "#EC NOTEXT
                            iv_left_type        = 'ApprHeader' "#EC NOTEXT
                            iv_right_type       = 'ApprComments' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - ApprHeaderToApprComments
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'DocumentType'   iv_dependent_property = 'DocumentType' ). "#EC NOTEXT
lo_ref_constraint->add_property( iv_principal_property = 'DocumentId'   iv_dependent_property = 'DocumentId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'ApprHeaderToApprCommentsSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ApprHeaderSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'ApprCommentsSet'             "#EC NOTEXT
                                              iv_association_name      = 'ApprHeaderToApprComments' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ApprHeaderToApprComments' "#EC NOTEXT
                                                              iv_abap_fieldname = 'APPRHEADERTOAPPRCOMMENTS' "#EC NOTEXT
                                                              iv_association_name = 'ApprHeaderToApprComments' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ApprHeaderToApprNodes' "#EC NOTEXT
                                                              iv_abap_fieldname = 'APPRHEADERTOAPPRNODES' "#EC NOTEXT
                                                              iv_association_name = 'ApprHeaderToApprNodes' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ApprHeaderToApprLanes' "#EC NOTEXT
                                                              iv_abap_fieldname = 'APPRHEADERTOAPPRLANES' "#EC NOTEXT
                                                              iv_association_name = 'ApprHeaderToApprLanes' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230517172850'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ApprLanes'.                            "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Id'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ApprNodes'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'DocumentType'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ApprComments'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
